...
includesAll(app, [
  ...
  "function guestOfferNeighborhoodOptions(",
  "guestNeighborhoodFallbacks",
  '"Brooklyn"',
  'optionSelect("neighborhood", t("filter_neighborhood_label", "Neighborhood"), filters.neighborhood, guestOfferNeighborhoodOptions(filters.neighborhood)',
